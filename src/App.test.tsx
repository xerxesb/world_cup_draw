  ...
  leaderboard: [
    {
      ...
      bestTeamPoints: 3,
      teams: [
        { name: "Belgium", tier: "A", points: 3, goalDifference: 2, position: 1, group: "A", advancing: true, isBonus: false, matched: true },
        { name: "South Korea", tier: "B", points: 0, goalDifference: -2, position: 2, group: "A", advancing: true, isBonus: false, matched: true },
        { name: "Uzbekistan", tier: "C", points: 0, goalDifference: 0, position: null, group: null, advancing: false, isBonus: false, matched: false },
      ],
    },
  ],
  status: {
